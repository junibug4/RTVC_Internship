...
double Kp = 0.2, Ki = 0.6, Kd = 0.2;   // these are the PID values. YOU MUST CHANGE THEM! Suggest you set all but one of them to zero and then increase that one until the input looks reasonable.
...
void loop()
{
  ...
  {LEDoutput=1;}
   ...
   delay(30);    //You can adjust this. I just set it at 300 so that there was time to look at the values but there doesnt even need to be a delay.
}
